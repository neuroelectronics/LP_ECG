...
__forceinline void dataMGR_enQueue_word_aligned(dataMGR* MGR,uint32_t data){	//fast enqueue function without boundary check
...
__forceinline uint16_t Manchester_converter_Byte(char x)
{
		uint16_t z=0;
		z |= ((x & 1U << 0)) << 0 | (~x & 1U << 0) << 1;
		z |= ((x & 1U << 1)) << 1 | (~x & 1U << 1) << 2;
...
__forceinline uint32_t Manchester_converter_Short(uint16_t x)
{
		uint32_t z=0;
		z |= ((x & 1U << 0)) << 0 | (~x & 1U << 0) << 1;
		z |= ((x & 1U << 1)) << 1 | (~x & 1U << 1) << 2;
		...
		z |= ((x & 1U << 7)) << 7 | (~x & 1U << 7) << 8;
		z |= ((x & 1U << 8)) << 8 | (~x & 1U << 8) << 9;
		z |= ((x & 1U << 9)) << 9 | (~x & 1U << 9) << 10;
		z |= ((x & 1U << 10)) << 10 | (~x & 1U << 10) << 11;
		z |= ((x & 1U << 11)) << 11 | (~x & 1U << 11) << 12;
		z |= ((x & 1U << 12)) << 12 | (~x & 1U << 12) << 13;
		z |= ((x & 1U << 13)) << 13 | (~x & 1U << 13) << 14;
		z |= ((x & 1U << 14)) << 14 | (~x & 1U << 14) << 15;
		z |= ((x & 1U << 15)) << 15 | (~x & 1U << 15) << 16;
		return z;
}
#endif
