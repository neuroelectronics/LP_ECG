...
#define HJ_UART LPUART1
#define HJ_UART_IRQn USART3_4_LPUART1_IRQn
#define HJ_DMA_TX DMA1_Channel1
...
#define HJ_CMD_SEQ 4
	...
	#define HJ_UART_DR HJ_UART->TDR
	#define HJ_DMA_TX_PAR HJ_DMA_TX->CPAR
	#define HJ_DMA_TX_MAR HJ_DMA_TX->CMAR
	#define HJ_DMA_TX_NDTR HJ_DMA_TX->CNDTR
	#define HJ_DMA_TX_CR HJ_DMA_TX->CCR
	#define USART_CR1_RXNEIE USART_CR1_RXNEIE_RXFNEIE
	#define USART_CR1_TXEIE USART_CR1_TXEIE_TXFNFIE
	#define USART_ISR_RXNE USART_ISR_RXNE_RXFNE
	#define USART_ISR_TXE USART_ISR_TXE_TXFNF
	#define UART_CHECK_TXE (READ_REG(HJ_UART->ISR)&(uint32_t)(USART_ISR_TXE_TXFNF))
	#define UART_CHECK_RXNE (READ_REG(HJ_UART->ISR)&(uint32_t)(USART_ISR_RXNE_RXFNE))
	...
	#define DMA_ENABLE(__HANDLE__)      ((__HANDLE__)->CCR |=  DMA_CCR_EN)
	#define DMA_DISABLE(__HANDLE__)     ((__HANDLE__)->CCR &=  ~DMA_CCR_EN)
	...
	#define HJ_UART_DR HJ_UART->DR
	#define HJ_DMA_TX_PAR HJ_DMA_TX->PAR
	#define HJ_DMA_TX_MAR HJ_DMA_TX->M0AR
	#define HJ_DMA_TX_NDTR HJ_DMA_TX->NDTR
	#define HJ_DMA_TX_CR HJ_DMA_TX->CR1
...
__forceinline void UART_DMA_Init(void){
	...
	HJ_DMA_TX_PAR = (uint32_t)&HJ_UART_DR;
